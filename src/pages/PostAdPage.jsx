  ...
  return (
    <div className="bg-[#f2f4f5] min-h-screen">
      <div className="max-w-2xl mx-auto px-4 py-7">
        ...
        <h1 className="text-xl font-black text-[#002f34] mb-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
            <h2 className="text-sm font-black text-[#002f34] uppercase tracking-wide">Ad Details</h2>

            <div>
              <label className="block text-xs font-bold text-[#002f34] mb-1.5 uppercase tracking-wide">Title *</label>
            ...
            <div>
              <label className="block text-xs font-bold text-[#002f34] mb-1.5 uppercase tracking-wide">Category *</label>
            ...
            <div>
              <label className="block text-xs font-bold text-[#002f34] mb-1.5 uppercase tracking-wide">Description *</label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-bold text-[#002f34] mb-1.5 uppercase tracking-wide">Price (PKR) *</label>
              ...
              <div>
                <label className="block text-xs font-bold text-[#002f34] mb-1.5 uppercase tracking-wide">Condition</label>
            ...
            <div>
              <label className="block text-xs font-bold text-[#002f34] mb-1.5 uppercase tracking-wide">Location *</label>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6">
            ...
            {previews.length > 0 && (
              <div className="flex gap-2 mt-4 flex-wrap">
                {previews.map((src, i) => (
                  <div key={i} className={`relative w-16 h-16 rounded-xl overflow-hidden border-2 ${i === 0 ? 'border-[#002f34]' : 'border-gray-200'}`}>
                    <img src={src} alt="" className="w-full h-full object-cover" />
                    {i === 0 && (
                      <span className="absolute bottom-0 left-0 right-0 text-center text-[9px] bg-[#002f34] text-[#ffce32] font-black py-0.5">
                        COVER
                      </span>
                    )}
                  </div>
          ...
          <button type="submit" disabled={loading}
            className="w-full bg-[#ffce32] hover:bg-yellow-400 text-[#002f34] font-black py-3.5 rounded-xl text-sm transition disabled:opacity-50">
