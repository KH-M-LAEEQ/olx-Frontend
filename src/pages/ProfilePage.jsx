  ...
  return (
    <div className="bg-[#f2f4f5] min-h-screen">
      <div className="max-w-lg mx-auto px-4 py-7">
        <h1 className="text-xl font-black text-[#002f34] mb-5">My Profile</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
          ...
          <div className="flex items-center gap-4 pb-5 border-b border-gray-100">
            <div className="relative shrink-0">
              <div className="w-16 h-16 rounded-full bg-[#002f34] overflow-hidden flex items-center justify-center">
                {preview
                  ? <img src={preview} alt="" className="w-full h-full object-cover" />
                  : <span className="text-[#ffce32] font-black text-xl">{user?.username?.[0]?.toUpperCase()}</span>
                }
              </div>
            ...
            <div>
              <p className="font-black text-[#002f34]">{user?.username}</p>
          ...
          {[
            ...
            <div key={f.name}>
              <label className="block text-xs font-bold text-[#002f34] mb-1.5 uppercase tracking-wide">{f.label}</label>
          ...
          <div>
            <label className="block text-xs font-bold text-[#002f34] mb-1.5 uppercase tracking-wide">Address</label>
